...
//|    Generated at 04/02/2026 15:59
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15, 2021.07.14 - 2026.03.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 1.8.178";
...
input int HullMovingAvrPrd1 = 80;        //HullMovingAvrPrd1
input double ProfitTarget1 = 50;        //ProfitTarget1
...
input string SignalTimeRangeTo = "07:00";
...
#define HULLMOVINGAVERAGE_1 3     //iCustom(NULL,0, "SqHullMovingAverage", HullMovingAvrPrd1, 2.0, PRICE_CLOSE)
#define PARABOLICSAR_1 4     //iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.1)
#define TRSMA_1 5     //iMA(NULL,0, 200, 0, MODE_SMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 1.8.178";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(HULLMOVINGAVERAGE_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(PARABOLICSAR_1, 0, 3), 6))
      &&   sqIsUptrend(NULL,0, 0, TRSMA_1)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.020, 0.1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[TRSMA_1] = iMA(NULL,0, 200, 0, MODE_SMA, PRICE_CLOSE);
