...
input string CustomComment = "Strategy 5.19.174";
...
input int VWAPVWAPPeriod1 = 141;        //VWAPVWAPPeriod1
input double ProfitTarget1 = 105;        //ProfitTarget1
...
#define KELTNERCHANNEL_1 0     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.5)
#define VWAP_1 1     //iCustom(NULL,0, "SqVWAP", VWAPVWAPPeriod1)
...
string sqStrategyName = "Strategy 5.19.174";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(VWAP_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(VWAP_1, 0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[VWAP_1] = iCustom(NULL,0, "SqVWAP", VWAPVWAPPeriod1);
