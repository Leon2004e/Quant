...
//|    Generated at 05/03/2026 17:44
//| 
//|    Backtested on FTMO_NZDUSD_M15 / M15, 2021.07.13 - 2026.05.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.8.175";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int EMAPeriod1 = 24;        //EMAPeriod1
input int EMAPeriod2 = 14;        //EMAPeriod2
...
#define EMA_2 2     //iMA(NULL,0, EMAPeriod2, 0, MODE_EMA, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 3.8.175";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(CCI_1, 1)>149.0)
      &&   (NormalizeDouble((double) sqGetIndicatorValue(EMA_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(EMA_2, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
