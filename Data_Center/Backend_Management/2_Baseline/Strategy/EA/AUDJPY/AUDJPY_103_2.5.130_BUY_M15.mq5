...
//|    Generated at 04/04/2026 06:02
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15, 2021.07.15 - 2026.03.31 
//+------------------------------------------------------------------+
...
input string SignalTimeRangeTo = "13:00";
...
#define TRUERANGE_1 2     //iCustom(NULL,0, "SqTrueRange");
...
string sqStrategyName = "Strategy 2.5.130";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(TRUERANGE_1, 0, 3), 6) < NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
