//+------------------------------------------------------------------+
//| Strategy 2.32.160 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 04/01/2026 10:53
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15, 2021.07.14 - 2026.03.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.32.160";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int RSIPeriod1 = 14;        //RSIPeriod1
input int KERbelowLevelPeriod1 = 48;        //KERbelowLevelPeriod1
input int QQEValue1RSIPeriod1 = 14;        //QQEValue1RSIPeriod1
input int QQEValue1sF1 = 5;        //QQEValue1sF1
input double StopLossCoef1 = 7;        //StopLossCoef1
...
input string SignalTimeRangeTo = "14:00";
...
#define RSI_1 0     //iRSI(NULL,0, RSIPeriod1, PRICE_CLOSE)
#define KAUFMANEFFICIENCYRATIO_1 1     //iCustom(NULL,0,"SqEfficiencyRatio",KERbelowLevelPeriod1)
#define QQE_1 2     //iCustom(NULL,0, "SqQQE", QQEValue1RSIPeriod1, QQEValue1sF1, 4.236, 0)
#define SMA_1 3     //iMA(NULL,0, SMAPeriod1, 0, MODE_SMA, PRICE_CLOSE)
#define MTATR_1 4     //iATR(NULL,0, MTATRPeriod1)
#define ATR_1 5     //iCustom(NULL, 0, "SqATR", 15)
...
string sqStrategyName = "Strategy 2.32.160";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(RSI_1, 1)<35)
      &&   ((sqGetIndicatorValue(KAUFMANEFFICIENCYRATIO_1, 1) < 0.75)
      &&   sqGetIndicatorValue(QQE_1, 0, 3, true) < sqGetIndicatorValue(QQE_1, 1, 3, true)))
)
   {
      // Action #1
        // Enter at Market
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 3,   (sqGetIndicatorValue(SMA_1, 0, 3) + (0.50 * sqGetIndicatorValue(MTATR_1, 0, 3)))), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[RSI_1] = iRSI(NULL,0, RSIPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KAUFMANEFFICIENCYRATIO_1] = iCustom(NULL,0,"SqEfficiencyRatio",KERbelowLevelPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[QQE_1] = iCustom(NULL,0, "SqQQE", QQEValue1RSIPeriod1, QQEValue1sF1, 4.236, 0);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("(sqGetIndicatorValue(SMA_1, 0, 3) + (0.50 * sqGetIndicatorValue(MTATR_1, 0, 3)))")) {
      return ((sqGetIndicatorValue(SMA_1, 0, 3) + (0.50 * sqGetIndicatorValue(MTATR_1, 0, 3))));
   }
