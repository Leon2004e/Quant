//+------------------------------------------------------------------+
//| Strategy 5.32.183 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/31/2026 09:08
//| 
//|    Backtested on FTMO_AUDUSD_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.32.183";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int ATRPeriod1 = 66;        //ATRPeriod1
input int ATRPeriod2 = 69;        //ATRPeriod2
...
string sqStrategyName = "Strategy 5.32.183";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(CCI_1, 0, 1), 6) >= NormalizeDouble((double) 170.0, 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 3), 6)))
)
   {
      // Action #1
        // Enter at Market
