# -*- coding: utf-8 -*-
"""
1_Data_Center/Data_Operations/Trade_Logger_FTMO_540136817.py
...
Start:
  python 1_Data_Center/Data_Operations/Trade_Logger_FTMO_540136817.py
...
# ============================================================
# CONFIG (Account 540136817)
# ============================================================

FIXED_MT5_DIR = Path(
    r"C:\Users\Leon\Desktop\MetaTrader 5 - Kopie - Kopie - Kopie (12) - Kopie - Kopie - Kopie - Kopie - Kopie"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "540136817"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "?wviT5wa4AH!2E")  # besser: ENV setzen
...
def build_closed_trades_from_deals(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for pos_id, g in df.groupby("position_id", sort=False):
        ...
        # nur wenn Exit existiert => geschlossen
        if g_out.empty:
            continue
        # wenn IN außerhalb des Fensters liegt: skip (Backfill deckt das i.d.R. ab)
        if g_in.empty:
            continue
