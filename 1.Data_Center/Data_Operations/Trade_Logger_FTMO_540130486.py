# -*- coding: utf-8 -*-
"""
1_Data_Center/Data_Operations/Trade_Logger_FTMO_540130486.py
...
Start:
  python 1_Data_Center/Data_Operations/Trade_Logger_FTMO_540130486.py
...
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "T4b*5J2si")  # besser: ENV setzen
