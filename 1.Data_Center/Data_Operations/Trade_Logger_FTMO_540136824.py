# -*- coding: utf-8 -*-
"""
1_Data_Center/Data_Operations/Trade_Logger_FTMO_540136824.py
...
Start:
  python 1_Data_Center/Data_Operations/Trade_Logger_FTMO_540136824.py
...
# ============================================================
# CONFIG (Account 540136824)
# ============================================================

FIXED_MT5_DIR = Path(
    r"C:\Users\Leon\Desktop\MetaTrader 5 - Kopie - Kopie - Kopie (8) - Kopie - Kopie - Kopie - Kopie"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "540136824"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "bXRS1Jl@")  # besser: ENV setzen
