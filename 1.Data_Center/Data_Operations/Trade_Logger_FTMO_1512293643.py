# -*- coding: utf-8 -*-
"""
1_Data_Center/Data_Operations/Trade_Logger_FTMO_1512293643.py
...
Start:
  python 1_Data_Center/Data_Operations/Trade_Logger_FTMO_1512293643.py
...
# ============================================================
# CONFIG (Account 1512293643)
# ============================================================

FIXED_MT5_DIR = Path(
    r"C:\Users\Leon\Desktop\MetaTrader 5 - Kopie - Kopie - Kopie (16) - Kopie - Kopie - Kopie - Kopie"
)

MT5_LOGIN = int(os.getenv("MT5_LOGIN", "1512293643"))
MT5_PASSWORD = os.getenv("MT5_PASSWORD", "M?a556h$")  # besser: ENV setzen
