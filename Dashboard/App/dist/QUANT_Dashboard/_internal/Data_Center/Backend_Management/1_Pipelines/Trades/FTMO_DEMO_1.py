# -*- coding: utf-8 -*-
"""
QUANT/Data_Center/Backend_Management/1_Pipelines/Trades/Trade_Logger/code.py
...
- Speichert inkrementell in:
    <QUANT_ROOT>/Data_Center/Data/1_Pipeline/Trades/live/account_<login>_<account_type>/closed_trades.db
- Polling im Loop
- Robuster gegen:
...
# CODE_REGISTRY
# ============================================================
# script_id: trades_mt5_closed_trade_logger
# script_name: MT5 Closed Trade Logger
# owner: Leon Everts
# status: active
# layer: 1_Pipeline
# domain: Trades
# asset_type: Pipeline
# purpose: Builds an incremental closed-trade ledger and current open-position state from MetaTrader 5 account history and live positions.
# inputs:
...
#   - data_pipeline
# notes:
#   - Output root is Data_Center/Data/1_Pipeline/Trades/live.
...
CODE_REGISTRY: Dict[str, object] = {
    ...
    "asset_type": "Pipeline",
    "purpose": (
        "Builds an incremental closed-trade ledger and current open-position "
        "state from MetaTrader 5 account history and live positions."
    ),
    "inputs": [
        "MetaTrader 5 terminal64.exe",
        "MT5 login/server/password from script defaults or environment variables",
