//+------------------------------------------------------------------+
//| Strategy 0.111778 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 05/04/2026 16:42
//| 
//|    Backtested on FTMO_GBPUSD_M15 / M15, 2021.07.13 - 2026.05.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.111778";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 79;        //EMAPeriod1
...
string sqStrategyName = "Strategy 0.111778";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqIsFalling(EMA_1, 2, false, 1 + 1, 0))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 0), 6) < NormalizeDouble((double) sqGetIndicatorValue(LOWEST_1, 0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
