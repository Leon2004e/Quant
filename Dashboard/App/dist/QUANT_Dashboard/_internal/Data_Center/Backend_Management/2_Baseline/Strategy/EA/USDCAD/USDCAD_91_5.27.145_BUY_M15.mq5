//+------------------------------------------------------------------+
//| Strategy 5.27.145 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 04/04/2026 07:52
//| 
//|    Backtested on FTMO_USDCAD_M15 / M15, 2021.07.15 - 2026.03.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.27.145";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int EMAPeriod1 = 39;        //EMAPeriod1
input int ATRPeriod1 = 14;        //ATRPeriod1
input int ATRPeriod2 = 84;        //ATRPeriod2
input int ATRPeriod3 = 44;        //ATRPeriod3
input double ProfitTargetCoef1 = 2.7;        //ProfitTargetCoef1
...
#define ATR_2 2     //iCustom(NULL,0, "SqATR", ATRPeriod2)
#define ATR_3 3     //iCustom(NULL,0, "SqATR", ATRPeriod3)
#define ATR_4 4     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 5.27.145";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(ATR_3, 0, 3), 6)))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_BUY, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_4, 1)), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_4, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_4] = iCustom(NULL, 0, "SqATR", 25);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("ProfitTargetCoef1 * sqGetIndicatorValue(ATR_4, 1)")) {
      return (ProfitTargetCoef1 * sqGetIndicatorValue(ATR_4, 1));
   }
