//+------------------------------------------------------------------+
//| Strategy 5.57.183 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 03/31/2026 13:46
//| 
//|    Backtested on FTMO_NZDUSD_M15 / M15, 2021.07.15 - 2026.03.13 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.57.183";
...
input int KAMAERPeriod1 = 33;        //KAMAERPeriod1
input int KAMAShortPeriod1 = 178;        //KAMAShortPeriod1
input int KAMALongPeriod1 = 15;        //KAMALongPeriod1
input double ProfitTarget1 = 20;        //ProfitTarget1
input double StopLoss1 = 90;        //StopLoss1
...
input string SignalTimeRangeFrom = "10:00";
...
#define KAMA_1 1     //iCustom(NULL,0, "SqKAMA", KAMAERPeriod1, KAMAShortPeriod1, KAMALongPeriod1)
#define LOWESTINRANGE_1 2     //iCustom(NULL,0, "SqLowestInRange", "11:00", "18:00")
...
string sqStrategyName = "Strategy 5.57.183";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 0 + 1, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(KAMA_1, 0, 2), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 2), 6)))
)
   {
      // Action #1
        // Enter at Market
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 1, ProfitTarget1), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "11:00", "18:00");
