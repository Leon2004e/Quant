//+------------------------------------------------------------------+
//| Strategy 6.65.147 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 04/27/2026 14:55
//| 
//|    Backtested on FTMO_EURGBP_M15 / M15, 2021.07.15 - 2026.04.14 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 6.65.147";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 5;        //Period1
input int ATRPeriod1 = 29;        //ATRPeriod1
input int MTATRPeriod1 = 54;        //MTATRPeriod1
input int ATRPeriod2 = 105;        //ATRPeriod2
input int MTATRPeriod2 = 61;        //MTATRPeriod2
input double ProfitTargetCoef1 = 3.6;        //ProfitTargetCoef1
input double StopLoss1 = 20;        //StopLoss1
...
input string SignalTimeRangeFrom = "14:00";
...
#define MTATR_2 4     //iATR(NULL,0, MTATRPeriod2)
#define ATR_3 5     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 6.65.147";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(ATR_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(MTATR_1, 0, 2), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(ATR_2, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(MTATR_2, 0, 1), 6))))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 1, StopLoss1), "Current");
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_SELL, openPrice, 2, ProfitTargetCoef1 * sqGetIndicatorValue(ATR_3, 1)), "Current");
      size = sqMMRiskFixedAccountPct("Current",ORDER_TYPE_SELL,openPrice,sl,mmRiskPercent,mmDecimals,mmStopLossPips,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MTATR_2] = iATR(NULL,0, MTATRPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_3] = iCustom(NULL, 0, "SqATR", 25);
