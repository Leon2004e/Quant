//+------------------------------------------------------------------+
//| Strategy 3.65.188 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 05/05/2026 16:32
//| 
//|    Backtested on FTMO_EURUSD_M15 / M15, 2021.07.15 - 2025.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 3.65.188";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 11111;        //MagicNumber
input int RSIPeriod1 = 14;        //RSIPeriod1
input int CCIPeriod1 = 40;        //CCIPeriod1
input double ProfitTarget1 = 35;        //ProfitTarget1
input double StopLossCoef1 = 4.4;        //StopLossCoef1
...
#define AWESOMEOSCILLATOR_1 1     //iAO(NULL,0)
#define CCI_1 2     //iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_OPEN)
#define ATR_1 3     //iCustom(NULL, 0, "SqATR", 25)
...
string sqStrategyName = "Strategy 3.65.188";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((sqGetIndicatorValue(RSI_1, 1)>66.0)
      &&   (sqGetIndicatorValue(AWESOMEOSCILLATOR_1, 2) > 0.0
      &&   (sqGetIndicatorValue(CCI_1, 3)>66.0)))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(sqGetSLLevel("Current", ORDER_TYPE_SELL, openPrice, 2, StopLossCoef1 * sqGetIndicatorValue(ATR_1, 1)), "Current");
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[CCI_1] = iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_OPEN);
