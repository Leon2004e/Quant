...
input string CustomComment = "Strategy 5.59.107";
...
input string SignalTimeRangeFrom = "05:00";
...
#define BOLLINGERBANDS_1 0     //iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE)
#define KELTNERCHANNEL_1 1     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.0)
#define LOWESTINRANGE_1 2     //iCustom(NULL,0, "SqLowestInRange", "3:30", "15:00")
#define KELTNERCHANNEL_2 3     //iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.5)
...
string sqStrategyName = "Strategy 5.59.107";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqClose(NULL,0, 1), 6) < NormalizeDouble((double) sqGetIndicatorValue(BOLLINGERBANDS_1, 1 + 1, 1), 6))
      &&   (NormalizeDouble((double) sqGetIndicatorValue(KELTNERCHANNEL_1, 0, 3), 6) > NormalizeDouble((double) sqGetIndicatorValue(LOWESTINRANGE_1, 0, 1), 6)))
)
   {
      // Action #1
        // Enter at Market
      ...
      pt = sqFixMarketPrice(sqGetPTLevel("Current", ORDER_TYPE_BUY, openPrice, 3,             sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 2)), "Current");
...
bool initIndicators(){
   ...
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BollingerBandsPrd1, 0, 2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_1] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 2.0);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LOWESTINRANGE_1] = iCustom(NULL,0, "SqLowestInRange", "3:30", "15:00");
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KELTNERCHANNEL_2] = iCustom(NULL,0, "SqKeltnerChannel", KeltnerChannelPrd1, 1.5);
...
double sqGetValueByIdentification(int idHash) {
   ...
   if(idHash == sqStringHash("sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 2)")) {
      return (sqGetIndicatorValue(KELTNERCHANNEL_2, 0, 2));
   }
