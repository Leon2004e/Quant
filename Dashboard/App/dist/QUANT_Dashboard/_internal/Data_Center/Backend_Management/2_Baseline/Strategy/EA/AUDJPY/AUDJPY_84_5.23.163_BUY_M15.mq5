...
input string CustomComment = "Strategy 5.23.163";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int CCIPeriod1 = 14;        //CCIPeriod1
input int LinearRegressionPrd1 = 30;        //LinearRegressionPrd1
input int SMMAPeriod1 = 30;        //SMMAPeriod1
input int BBerPeriod1 = 50;        //BBerPeriod1
input double ProfitTarget1 = 30;        //ProfitTarget1
...
#define CCI_1 0     //iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_CLOSE)
#define LINEARREGRESSION_1 1     //iCustom(NULL,0, "SqLinReg", LinearRegressionPrd1, PRICE_CLOSE)
#define SMMA_1 2     //iMA(NULL,0, SMMAPeriod1, 0, MODE_SMMA, PRICE_CLOSE)
#define BOLLINGERBANDS_1 3     //iBands(NULL,0, BBerPeriod1, 0, 2.0, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 5.23.163";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(CCI_1, 0, 1), 6) <= NormalizeDouble((double) -137.0, 6))
      &&   ((NormalizeDouble((double) sqGetIndicatorValue(LINEARREGRESSION_1, 0, 1), 6) > NormalizeDouble((double) sqGetIndicatorValue(SMMA_1, 0, 2), 6))
      &&   (sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1+1)<sqGetIndicatorValue(BOLLINGERBANDS_1, 2, 1))))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[BOLLINGERBANDS_1] = iBands(NULL,0, BBerPeriod1, 0, 2.0, PRICE_CLOSE);
