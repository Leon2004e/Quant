//+------------------------------------------------------------------+
//| Strategy 0.154053 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 05/05/2026 04:15
//| 
//|    Backtested on FTMO_AUDUSD_M15 / M15, 2021.07.15 - 2025.01.01 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 0.154053";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 11111;        //MagicNumber
input int Period1 = 8;        //Period1
input double ProfitTarget1 = 40;        //ProfitTarget1
input double TrailingStopCoef1 = 1.5;        //TrailingStopCoef1
...
#define ATR_1 1     //iCustom(NULL, 0, "SqATR", 60)
...
string sqStrategyName = "Strategy 0.154053";
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 60);
