//+------------------------------------------------------------------+
//| Strategy 5.21.176 EA
//|
//|    Generated by StrategyQuant X Build 142 for AlgoCloud
//|    Generated at 04/28/2026 03:48
//| 
//|    Backtested on FTMO_AUDJPY_M15 / M15, 2021.07.15 - 2026.04.14 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 5.21.176";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 11111;        //MagicNumber
input int Period1 = 8;        //Period1
input int MAPeriod1 = 20;        //MAPeriod1
input double ProfitTargetCoef1 = 4;        //ProfitTargetCoef1
...
input string SignalTimeRangeFrom = "07:00";
...
#define MOVINGAVERAGE_1 1     //iMA(NULL,0, MAPeriod1, 0, MODE_EMA, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 30)
#define ATR_2 3     //iCustom(NULL, 0, "SqATR", 40)
#define RSI_1 4     //iRSI(NULL,0, RSIPeriod1, PRICE_CLOSE)
...
string sqStrategyName = "Strategy 5.21.176";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   (sqGetIndicatorValue(MOVINGAVERAGE_1, 1+1)<sqGetIndicatorValue(MOVINGAVERAGE_1, 1)))
)
   {
      // Action #1
        // Enter at Market
      openPrice = 0;  //Open at current market price
      sl = sqFixMarketPrice(0, "Current");
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (sqGetIndicatorValue(RSI_1, 1)>75)
)
   {
      // Action #1
        // Close all positions
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[MOVINGAVERAGE_1] = iMA(NULL,0, MAPeriod1, 0, MODE_EMA, PRICE_CLOSE);
