//+------------------------------------------------------------------+
//| Strategy 2.37.164 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 04/24/2026 14:59
//| 
//|    Backtested on FTMO_GBPJPY_M15 / M15, 2021.07.15 - 2026.04.14 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 2.37.164";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 6;        //Period1
input int DEMPeriod1 = 80;        //DEMPeriod1
input double ProfitTarget1 = 120;        //ProfitTarget1
input double TrailingStopCoef1 = 2.7;        //TrailingStopCoef1
...
#define DEMARKER_1 1     //iDeMarker(NULL,0, DEMPeriod1)
#define ATR_1 2     //iCustom(NULL, 0, "SqATR", 185)
...
string sqStrategyName = "Strategy 2.37.164";
...
//------------------------
   if (_sqIsBarOpen == true
      ...
      &&   sqIsFalling(DEMARKER_1, 2, false, 3))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[DEMARKER_1] = iDeMarker(NULL,0, DEMPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(NULL, 0, "SqATR", 185);
