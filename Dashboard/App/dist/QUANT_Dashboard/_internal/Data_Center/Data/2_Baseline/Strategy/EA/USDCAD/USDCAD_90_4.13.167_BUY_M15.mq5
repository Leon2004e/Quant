//+------------------------------------------------------------------+
//| Strategy 4.13.167 EA
//|
//|    Generated by StrategyQuant X Build 142 for MetaTrader
//|    Generated at 04/02/2026 17:34
//| 
//|    Backtested on FTMO_GBPJPY_M15 / M15, 2021.07.14 - 2026.03.31 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy 4.13.167";
bool IndicatorLoadedWithoutError = true;
input int MagicNumber = 0;        //MagicNumber
input int Period1 = 6;        //Period1
input int ATRPeriod1 = 14;        //ATRPeriod1
input int CCIPeriod1 = 62;        //CCIPeriod1
input int KAMAERPeriod1 = 164;        //KAMAERPeriod1
input int KAMAShortPeriod1 = 119;        //KAMAShortPeriod1
input int KAMALongPeriod1 = 73;        //KAMALongPeriod1
input int KAMAERPeriod2 = 116;        //KAMAERPeriod2
input int KAMAShortPeriod2 = 34;        //KAMAShortPeriod2
input int KAMALongPeriod2 = 81;        //KAMALongPeriod2
input double ProfitTarget1 = 100;        //ProfitTarget1
...
input string SignalTimeRangeFrom = "06:00";
input string SignalTimeRangeTo = "12:00";
...
#define HIGHEST_1 0     //iCustom(NULL,0, "SqHighest", Period1, PRICE_CLOSE)
#define LOWEST_1 1     //iCustom(NULL,0, "SqLowest", Period1, PRICE_CLOSE)
#define ATR_1 2     //iCustom(NULL,0, "SqATR", ATRPeriod1)
#define CCI_1 3     //iCustom(NULL,0, "SqCCI", CCIPeriod1, PRICE_CLOSE)
#define KAMA_1 4     //iCustom(NULL,0, "SqKAMA", KAMAERPeriod1, KAMAShortPeriod1, KAMALongPeriod1)
#define KAMA_2 5     //iCustom(NULL,0, "SqKAMA", KAMAERPeriod2, KAMAShortPeriod2, KAMALongPeriod2)
...
string sqStrategyName = "Strategy 4.13.167";
...
//------------------------
   if (_sqIsBarOpen == true
      &&   (((NormalizeDouble((double) (sqGetIndicatorValue(HIGHEST_1, 0, 2) - sqGetIndicatorValue(LOWEST_1, 0, 2)), 6) < NormalizeDouble((double) (sqGetIndicatorValue(ATR_1, 0, 1) * 3), 6))
      &&   (NormalizeDouble((double) sqClose(NULL,0, 0), 6) > NormalizeDouble((double) sqGetIndicatorValue(HIGHEST_1, 0, 1), 6)))
      &&   (((sqGetIndicatorValue(CCI_1, 1)>70.0)
      &&   sqGetIndicatorValue(KAMA_1, 0, 2+1)<sqGetIndicatorValue(KAMA_1, 0, 2))
      &&   sqGetIndicatorValue(KAMA_2, 0, 2+1)<sqGetIndicatorValue(KAMA_2, 0, 2)))
)
   {
      // Action #1
        // Enter at Market
...
bool initIndicators(){
   ...
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KAMA_1] = iCustom(NULL,0, "SqKAMA", KAMAERPeriod1, KAMAShortPeriod1, KAMALongPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[KAMA_2] = iCustom(NULL,0, "SqKAMA", KAMAERPeriod2, KAMAShortPeriod2, KAMALongPeriod2);
